...
export const PdfPreviewer = () => {
  ...
  const [, handleDownload] = useDownloadPdf('/public/haris-developer-cv.pdf', 'Haris-Developer-CV.pdf');
  return (
    <Worker workerUrl="https://unpkg.com/pdfjs-dist@3.11.174/build/pdf.worker.min.js">
      <div className="h-full overflow-hidden p-2">
        ...
        <Viewer fileUrl={'/public/haris-developer-cv.pdf'} plugins={[zoomPluginInstance, fullScreenPluginInstance]} />
      </div>
    </Worker>
  );
};
